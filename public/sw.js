...
self.addEventListener("fetch", (event) => {
  ...
  /* page navigations: NETWORK-FIRST so a new deploy's HTML (and its fresh chunk
   * hashes) always win; cache is only an offline fallback. Serving a stale
   * cached shell here would reference old chunks that 404 after a deploy. */
